...
namespace ShoeSystem
{
    public partial class FormSaleSearch : Form
    {
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            ...
            if (((dataGridView1 != null)) && (dataGridView1.RowCount > 0))
            {
                ...
                try
                {
                    ...
                    productDesc = dataGridView1[2, row_current].Value.ToString();
                    productQty = dataGridView1[3, row_current].Value.ToString();
                }
                catch
                {
                    productId = "";
        ...
        private void FormSaleSearch_Load(object sender, EventArgs e)
        {
            ...
            objConn.Open();
            strSQL = "SELECT Id_product as รหัสสินค้า, N_product as ชื่อสินค้า, N_product_desc as รายละเอียด ,unit as จำนวนที่มี FROM tbproduct ";
            ...
            try
            {
                ...
                productDesc = dataGridView1[2, 0].Value.ToString();
